...
function ratingFromSetup(args: {
  ...
  if (args.hasSurgePullbackSetup && args.surgePullbackScore >= 72 && args.flowRatio5d > -0.025 && (args.flowToday > 0 || args.flowAcceleration > 0)) {
    return { signal: "watch" as const, rating: "观察" };
  }
